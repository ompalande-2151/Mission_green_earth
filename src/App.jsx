...
const App = () => {
  ...
  const onSubmit = async e => {
    ...
    try {
      ...
      await fetch("https://script.google.com/macros/s/AKfycbwzdj2j86hMF3fQYHuHlXKrLmZb3UlO-_tb6IjlJm8P6EVhC-PXRuGIRhgDuQORM_5p/exec", {
        method: "POST",
        mode: "no-cors",
        body: formBody,
      });
